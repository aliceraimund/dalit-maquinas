        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {maquina.destaque && (
                <span className="rounded-full bg-[var(--cor-primaria)] px-3 py-1 text-sm font-semibold text-[var(--cor-texto)]">
                  Destaque
                </span>
              )}
              {maquina.status && (
          ...
          <aside className="lg:sticky lg:top-6 lg:self-start">
            <div className="space-y-4 rounded-xl border border-[var(--cor-borda)] bg-white p-5 shadow-sm">
              ...
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--cor-primaria)] px-4 py-3 font-semibold text-[var(--cor-texto)] transition-colors hover:bg-[var(--cor-primaria-hover)]"
              >
