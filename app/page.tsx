    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="hero-bg text-white">
        <div className="mx-auto max-w-6xl px-4 pb-10 pt-14 sm:pt-20">
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="flex items-center gap-2 rounded-lg border border-white/40 px-6 py-3 font-semibold text-white transition-colors hover:bg-white/10"
                >
          ...
          {/* Cards de categoria clicáveis (filtro rápido) */}
          <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {CATEGORIAS_VALIDAS.map((cat) => (
              <Link
                key={cat}
                href={`/?categoria=${cat}#catalogo`}
                className="group rounded-xl border border-white/15 bg-white/10 p-4 backdrop-blur transition-all hover:-translate-y-0.5 hover:border-[var(--cor-acento)] hover:bg-white/15"
              >
                <span className="text-[var(--cor-acento)]">{ICONES_CATEGORIA[cat]}</span>
                <p className="mt-2 font-bold">{CATEGORIA_LABELS[cat]}</p>
